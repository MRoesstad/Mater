...
parser.add_argument("--dataset_split", required=True)
parser.add_argument("--dataset_split_type", default=None)
parser.add_argument("--datasets_path", default=config.datasets_path)
parser.add_argument("--renderer_type", default="vispy")
parser.add_argument("--delta", type=float, default=15)
parser.add_argument("--vis_visibility_masks", action="store_true")
args = parser.parse_args()

print("FIXED: dataset_name =", args.dataset)
...
p = {
    ...
    "delta": args.delta,
    "vis_visibility_masks": args.vis_visibility_masks,
    "modality": None,
    "sensor": None,
